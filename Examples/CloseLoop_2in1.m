function PN_model=CloseLoop_2in1()

%Make null PN model
[PN_model] = Init_PN('CloseLoop_2in1');
...
[PN_model,t6]=New_Transition(PN_model,'T6', 'General_func',2,4,0,1,1);
...
PN_model=Arc_T2P(PN_model,t6,p3);
