function PN_model=Exclusion1()

%Make null PN model
[PN_model] = Init_PN('Exclusion1');
...
%---------------------------------------------------------------
[PN_model,t1]=New_Transition(PN_model,'T1', 'General_func',2,20,0,1,1);
[PN_model,t2]=New_Transition(PN_model,'T2', 'General_func',2,15,0,1,1);
[PN_model,t3]=New_Transition(PN_model,'T3', 'General_func',2,8,0,1,1);
[PN_model,t4]=New_Transition(PN_model,'T4', 'General_func',2,12,0,1,1);
[PN_model,t5]=New_Transition(PN_model,'T5', 'General_func',2,6,0,1,1);
[PN_model,t6]=New_Transition(PN_model,'T6', 'General_func',2,14,0,1,1);


%Add Communication Arcs
% PN_model=Weight_InhArc_P2T(PN_model,p1,t1,3);
...
PN_model=Arc_P2T(PN_model,p4,t2);
PN_model=Arc_P2T(PN_model,p4,t5);
PN_model=Arc_T2P(PN_model,t5,p7);
PN_model=Arc_P2T(PN_model,p7,t6);
PN_model=Arc_T2P(PN_model,t6,p5);
PN_model=Arc_T2P(PN_model,t6,p4);
PN_model=Arc_P2T(PN_model,p5,t4);
