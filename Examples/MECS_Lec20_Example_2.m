function PN_model=MECS_Lec20_Example_2()
[PN_model] = Init_PN('MECS_Lec20_Example_2');
%Define Places
...
[PN_model,p6]=New_Place(PN_model,'P6',1,1,{});
[PN_model,p7]=New_Place(PN_model,'P7',1,1,{});
...
PN_model=Weighted_Arc_P2T(PN_model,p6,t2,1);
PN_model=Weighted_Arc_P2T(PN_model,p7,t3,1);
PN_model=Weighted_Arc_T2P(PN_model,t4,p6,1);
PN_model=Weighted_Arc_T2P(PN_model,t5,p7,1);
PN_model=Weighted_Arc_T2P(PN_model,t2,p4,1);
PN_model=Weighted_Arc_T2P(PN_model,t3,p5,1);
