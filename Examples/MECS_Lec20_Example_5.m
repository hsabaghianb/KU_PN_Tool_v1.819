function PN_model=MECS_Lec20_Example_1()
[PN_model] = Init_PN('MECS_Lec20_Example_1');
%Define Places
...
[PN_model,t4]=New_Transition(PN_model,'T4', 'General_func',0,4,0,0,1);
[PN_model,t5]=New_Transition(PN_model,'T5', 'General_func',0,4,0,0,1);
