function PN_model=Paper_example4()

%Make null PN model
[PN_model] = null_model_PN('Paper_example4');
...
[PN_model,t6]=New_Transition(PN_model,'t6', 'General_func',1,0,0,1,1);
[PN_model,t7]=New_Transition(PN_model,'t7', 'General_func',0,0,64,1,1);
