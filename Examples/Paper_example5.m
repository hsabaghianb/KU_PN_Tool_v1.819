function PN_model=Paper_example5()

%Make null PN model
[PN_model] = null_model_PN('Paper_example5');
...
[PN_model,t1]=New_Transition(PN_model,'t1', 'General_func',0,0,2,1,0.8);
[PN_model,t2]=New_Transition(PN_model,'t2', 'General_func',0,0,1,1,0.2);
[PN_model,t3]=New_Transition(PN_model,'t3', 'General_func',1,0,0,1,1);
[PN_model,t4]=New_Transition(PN_model,'t4', 'General_func',1,0,0,1,1);
[PN_model,t5]=New_Transition(PN_model,'t5', 'General_func',1,20,0,1,1);


%Add Communication Arcs
PN_model=Arc_P2T(PN_model,p0,t0);
PN_model=Weighted_Arc_T2P(PN_model,t0,p1,3);
...
PN_model=Weighted_Arc_P2T(PN_model,p4,t5,3);
