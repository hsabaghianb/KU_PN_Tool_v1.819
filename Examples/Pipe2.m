function PN_model=Pipe1()

%Make null PN model
[PN_model] = Init_PN('Pipe1');

%Define Places
%---------------------------------------------------------------
% [PN_model,Pl_num]=New_Place(PN_model,Name,Cap,Type,Marking)
%---------------------------------------------------------------
[PN_model,p1]=New_Place(PN_model,'P1',1,1,{[0,0,0,0]});
...
[PN_model,t2]=New_Transition(PN_model,'T2', 'General_func',1,3,0,4,1);
[PN_model,t3]=New_Transition(PN_model,'T3', 'General_func',1,4,0,3,1);
[PN_model,t4]=New_Transition(PN_model,'T4', 'General_func',1,2,0,2,1);
[PN_model,t5]=New_Transition(PN_model,'T5', 'General_func',1,3,0,1,1);
