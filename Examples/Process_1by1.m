function PN_model=Process_1by1()

%Make null PN model
[PN_model] = Init_PN('Process_1by1');
...
%---------------------------------------------------------------
[PN_model,t1]=New_Transition(PN_model,'T1', 'General_func',1,5,0,1,1);
[PN_model,t2]=New_Transition(PN_model,'T2', 'General_func',1,7,0,1,1);
[PN_model,t3]=New_Transition(PN_model,'T3', 'General_func',1,4,0,1,1);
[PN_model,t4]=New_Transition(PN_model,'T4', 'General_func',1,4,0,1,1);
...
PN_model=Arc_P2T(PN_model,p4,t1);
