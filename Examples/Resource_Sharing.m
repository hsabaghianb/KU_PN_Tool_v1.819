function PN_model=Resource_Sharing()

%Make null PN model
[PN_model] = Init_PN('Resource_Sharing');
...
%---------------------------------------------------------------
[PN_model,t1]=New_Transition(PN_model,'T1', 'General_func',1,40,0,1,1);
[PN_model,t2]=New_Transition(PN_model,'T2', 'General_func',1,60,0,1,1);
[PN_model,t3]=New_Transition(PN_model,'T3', 'General_func',1,100,0,1,1);
[PN_model,t4]=New_Transition(PN_model,'T4', 'General_func',1,100,0,1,1);
